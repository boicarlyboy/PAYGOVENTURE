...
export default function GroupsPage() {
  ...
  const handleJoinWhatsApp = () => {
    window.open("https://chat.whatsapp.com/HDymkEuQvZiIFv0dMbhzMw?s=cl&p=i&mlu=0", "_blank")
  }

  const handleJoinTelegram = () => {
    window.open("https://chat.whatsapp.com/HDymkEuQvZiIFv0dMbhzMw?s=cl&p=i&mlu=0")
  }
